...
def calculate_shift_delta(seed: int, min_weeks: int = 520, max_weeks: int = 520*2) -> timedelta:
    """
...
def shift_dates(
    ...
    # Case 3: Shifting list of dates or DatetimeIndex
        ...
        raise ValueError("Must provide either a DataFrame, date range parameters, or list of dates")
