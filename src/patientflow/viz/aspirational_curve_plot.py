...
def plot_curve(directory_path, figsize, title_, x1, y1, x2, y2, include_titles = False, text_size = None, file_name = None):
    gamma, lamda, a, x_values, y_values  = create_curve(x1, y1, x2, y2, generate_values=True) 
