...
def create_colour_dict():
    ...
    def generate_continuous_colormap(base_color):
        ...
        return mcolors.LinearSegmentedColormap('custom_colormap', segmentdata=cdict, N=256)
...
def in_ED_now_plot(directory_path, file_name, ex, horizon_datetime, figsize, title_, include_titles = False, truncate_at_hours=8, colour=False, text_size = None, jitter_amount=0.1, size = 50, preds_col = 'preds', colour_map = 'Spectral_r', 
