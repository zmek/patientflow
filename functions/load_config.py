...
def load_config_file(config_file_path, return_start_end_dates=False):
    try:
    ...
    try:
        ...
        if return_start_end_dates:
            ...
            return (prediction_times, start_training_set, start_validation_set, start_test_set, end_test_set, x1, y1, x2, y2, prediction_window)
